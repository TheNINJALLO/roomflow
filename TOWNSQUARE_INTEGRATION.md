...
3. For each requested control, click the matching Townsquare control. The click is captured for mapping and does not submit the form.
...
Mappings include customer/property search and creation, estimate fields, repeated line items, tax, discount, notes, terms, deposit, expiration, attachment input, total, status, Save Draft, and estimate detail/review confirmation.
